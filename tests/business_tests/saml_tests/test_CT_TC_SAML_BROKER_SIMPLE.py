...
class Test_CT_TC_SAML_SSO_BROKER_SIMPLE():
    ...
    def test_CT_TC_SAML_SSO_BROKER_SIMPLE_SP_initiated(self, settings):
        ...
        response = req.send_credentials_to_idp(logger, s, header, idp2_ip, idp2_port, referer_url, url_form, credentials_data, {**keycloak_cookie2,**session_cookie}, method_form)
